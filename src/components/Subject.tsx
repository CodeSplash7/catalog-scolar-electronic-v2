// fonts
import { magra_700, open_sans_600, open_sans_800 } from "@/fonts";
// utils
  ...
  return (
    ...
    >
      ...
      >
        ...
        <OverAllAverage subject={subject} />
        <ActivityHeading subject={subject} />
        <ConduitHeading subject={subject} />
        <Activity subject={subject} />
        <Conduit subject={subject} />
      </div>
    </ClickTracker>
  );
}
...
const SubjectHeader: FC<{ subject: Subject }> = ({ subject }) => (
...
const Absences: FC<{ subject: Subject }> = ({ subject }) => (
...
const Grades: FC<{ subject: Subject }> = ({ subject }) => (
  <div className="col-span-1 row-span-1 flex flex-col p-[7px_15px_15px_8px] border border-gray-300">
    {subject.grades.map((g) => (
      <div key={g.id.$oid} className="flex text-[#454545] items-center ">
        ...
        <div className={`text-[13px] font-bold ${open_sans_600.className}`}>
...
const Average: FC<{ subject: Subject }> = ({ subject }) => (
  <div
...
const OverAllAverage: FC<{ subject: Subject }> = ({ subject }) => (
  <div
    className={`col-span-3 row-span-1 p-[10px] text-start ${magra_700.className} text-[#AC2400] border border-gray-300`}
  >
...
const Activity: FC<{ subject: Subject }> = ({ subject }) => (
  <div
...
const Conduit: FC<{ subject: Subject }> = ({ subject }) => (
  <div
